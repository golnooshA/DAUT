...
start_epoch = 0
generator_checkpoint = os.path.join(SAVE_DIR, 'generator_epoch_165.pth')
discriminator_checkpoint = os.path.join(SAVE_DIR, 'discriminator_epoch_165.pth')
optimizer_checkpoint = os.path.join(SAVE_DIR, 'optimizer_epoch_165.pth')
...
if os.path.exists(generator_checkpoint) and os.path.exists(discriminator_checkpoint) and os.path.exists(optimizer_checkpoint):
    ...
    print("Resuming from checkpoint at epoch 165.")
    start_epoch = 165
else:
